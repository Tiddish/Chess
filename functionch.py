...
def turn(firstTurn):
    ...
    if firstTurn != deck[row][colomn].color:
        print("вы не можете сделать ход фигурой другого цвета")
        turn()
    row1,colomn1 = decoder(input("Введите ход: "))
    if firstTurn == deck[row1][colomn1].color:
        print("вы не можете побить фигуру вашего же цвета")
        turn()
